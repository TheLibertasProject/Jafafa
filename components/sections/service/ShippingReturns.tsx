  ...
  return (
    <main className="page-enter">
      ...
      <section className="w-full max-w-[1440px] mx-auto px-10 max-[720px]:px-5 pt-[40px] pb-16 max-[880px]:pb-10">
        <div className="font-mono text-[11px] tracking-[0.18em] uppercase text-ink-2">Shipping &amp; returns</div>
        <h1
        ...
        <div className="pt-14">
          ...
          <div className="border-t border-line">
            <div className="grid grid-cols-[1.4fr_1fr_1.2fr] gap-10 py-4 border-b border-line-soft max-[600px]:hidden">
              <span className="font-mono text-[10px] tracking-[0.16em] uppercase text-muted">Region</span>
              <span className="font-mono text-[10px] tracking-[0.16em] uppercase text-muted">Time</span>
              <span className="font-mono text-[10px] tracking-[0.16em] uppercase text-muted">Cost</span>
            </div>
            {SHIPPING_ROWS.map((row) => (
              ...
              >
                ...
                <span className="text-ink-2 text-[15px]">{row.time}</span>
                <span className="text-ink-2 text-[15px]">{row.cost}</span>
              </div>
            ))}
          </div>

          <p className="text-[14px] leading-[1.7] text-ink-2 max-w-[52ch] mt-8">
        ...
        <div className="pt-14">
          ...
          <div className="grid grid-cols-2 gap-16 max-[720px]:grid-cols-1 max-[720px]:gap-10">
            <div>
              ...
              <p className="text-ink-2 text-[15px] leading-[1.7] max-w-[44ch]">
        ...
        <div className="pt-14">
          ...
          <div className="grid grid-cols-3 border-t border-line border-b max-[720px]:grid-cols-1">
            {REFILL_STEPS.map((step) => (
              ...
              >
                <div className="font-mono text-[10.5px] tracking-[0.18em] uppercase text-muted">N° {step.no}</div>
                <div className="font-serif font-light text-[26px] mt-3 mb-2">{step.hd}</div>
                <div className="text-[14px] text-ink-2 leading-[1.6] max-w-[36ch]">{step.bd}</div>
              </div>
            ))}
          </div>
        </div>
